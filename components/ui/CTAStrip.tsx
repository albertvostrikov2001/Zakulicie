    ...
    return (
      ...
      >
        <div className="mx-auto flex max-w-content flex-col items-stretch gap-4 px-4 py-7 sm:flex-row sm:items-center sm:justify-between md:px-8">
          <p className="text-center text-[15px] font-semibold text-[#0A0A0A] sm:text-left sm:text-[16px]">
            {text}
          </p>
          <CTALink
            className="inline-flex shrink-0 self-end items-center justify-center border-[1.5px] border-[#0A0A0A] bg-transparent px-7 py-3.5 text-[12px] font-semibold uppercase tracking-[0.12em] text-[#0A0A0A] transition-[background-color,color] duration-[250ms] ease-out hover:bg-[#0A0A0A] hover:text-accent focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-[#0A0A0A] sm:self-auto"
          >
            Обсудить проект
          </CTALink>
        </div>
