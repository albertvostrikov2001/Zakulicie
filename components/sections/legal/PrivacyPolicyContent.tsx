...
function ListItem({ children }: { children: React.ReactNode }) {
  return <li className="pl-0 before:content-none">— {children}</li>;
}

function SectionList({ children }: { children: React.ReactNode }) {
  return <ul className="mt-3 list-none space-y-2 pl-0 text-sm leading-relaxed text-text-secondary">{children}</ul>;
}

export function PrivacyPolicyContent({ siteUrl }: PrivacyPolicyContentProps) {
  const policyUrl = `${siteUrl}/privacy-policy`;

  return (
    <div className="mt-10 max-w-3xl space-y-8 text-sm leading-relaxed text-text-secondary">
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          обеспечению безопасности персональных данных, предпринимаемые Елгиной Екатериной
          Эдуардовной (далее — Оператор).
        </p>
        <p className="mt-3">
        ...
        <p className="mt-3">
          ...
          веб-сайта{" "}
          <a href={siteUrl} className="text-accent underline-offset-2 hover:underline">
            {siteUrl}
          </a>
          .
        </p>
      ...
      <section>
        <h2 className="font-display text-xl text-text-primary">2. Основные понятия, используемые в Политике</h2>
        <SectionList>
          <ListItem>
      ...
      <section>
        <h2 className="font-display text-xl text-text-primary">3. Основные права и обязанности Оператора</h2>
        <p className="mt-3 font-medium text-text-primary">3.1. Оператор имеет право:</p>
        <SectionList>
          <ListItem>
        ...
        <p className="mt-4 font-medium text-text-primary">3.2. Оператор обязан:</p>
        <SectionList>
          <ListItem>
      ...
      <section>
        ...
        <p className="mt-3 font-medium text-text-primary">4.1. Субъекты персональных данных имеют право:</p>
        <SectionList>
          <ListItem>
          ...
          <ListItem>на осуществление иных прав, предусмотренных законодательством РФ.</ListItem>
        </SectionList>
        <p className="mt-4 font-medium text-text-primary">4.2. Субъекты персональных данных обязаны:</p>
        <SectionList>
          <ListItem>предоставлять Оператору достоверные данные о себе;</ListItem>
          <ListItem>
      ...
      <section>
        <h2 className="font-display text-xl text-text-primary">5. Принципы обработки персональных данных</h2>
        <SectionList>
          <ListItem>5.1. Обработка персональных данных осуществляется на законной и справедливой основе.</ListItem>
          <ListItem>
      ...
      <section>
        <h2 className="font-display text-xl text-text-primary">6. Цели обработки персональных данных</h2>
        <dl className="mt-4 grid gap-4 border border-border bg-surface/50 p-6">
          <div>
            <dt className="text-text-muted">Цель обработки</dt>
            <dd className="mt-1 text-text-primary">
              информирование Пользователя посредством отправки электронных писем
            </dd>
          </div>
          <div>
            <dt className="text-text-muted">Персональные данные</dt>
            <dd className="mt-1 text-text-primary">
          ...
          <div>
            <dt className="text-text-muted">Правовые основания</dt>
            <dd className="mt-1 text-text-primary">
          ...
          <div>
            <dt className="text-text-muted">Виды обработки персональных данных</dt>
            <dd className="mt-1 text-text-primary">Передача персональных данных</dd>
          </div>
        </dl>
      </section>

      <section>
        <h2 className="font-display text-xl text-text-primary">7. Условия обработки персональных данных</h2>
        <SectionList>
          <ListItem>
      ...
      <section>
        ...
        <SectionList>
          ...
          <ListItem>
            ...
            <a href="mailto:Zakulisie54@gmail.com" className="text-accent underline-offset-2 hover:underline">
      ...
      <section>
        <h2 className="font-display text-xl text-text-primary">10. Трансграничная передача персональных данных</h2>
        <SectionList>
          <ListItem>
      ...
      <section>
        <h2 className="font-display text-xl text-text-primary">11. Конфиденциальность персональных данных</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="font-display text-xl text-text-primary">12. Заключительные положения</h2>
        <p className="mt-3">
        ...
        <p className="mt-3">
          ...
          адресу{" "}
          <a href={policyUrl} className="text-accent underline-offset-2 hover:underline">
            {policyUrl}
          </a>
          .
        </p>
